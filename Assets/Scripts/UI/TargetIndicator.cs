...
public class TargetIndicator : MonoBehaviour
{
    ...
    private void UpdateTargetIconPosition()
    {
        ...
        newPos.x = Mathf.Clamp(newPos.x, m_edgeBuffer, mainCamera.pixelWidth - m_edgeBuffer);
        newPos.y = Mathf.Clamp(newPos.y, m_edgeBuffer, mainCamera.pixelHeight - m_edgeBuffer);
        newPos.z = 0f;
